...
export default function LayoutProjectDetail({
  children,
}: {
  ...
  return (
    <>
      <div className="pointer-events-none fixed left-0 top-0 z-10 h-12 w-full bg-gray-100backdrop-blur-xl [-webkit-mask-image:linear-gradient(to_bottom,black,transparent)] dark:bg-zinc-950" />
      <ScrollProgress
      ...
      <BackButton label="返回项目" href="/projects" />
